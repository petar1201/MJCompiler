...
public class MatchedMultipletStatements extends Matched {

    private MultipleStatements MultipleStatements;

    public MatchedMultipletStatements (MultipleStatements MultipleStatements) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("MatchedMultipletStatements(\n");
