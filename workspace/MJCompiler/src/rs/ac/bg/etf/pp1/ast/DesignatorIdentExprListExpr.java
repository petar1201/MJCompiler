...
public class DesignatorIdentExprListExpr extends DesignatorIdentExprList {

    private DesignatorIdentExprList DesignatorIdentExprList;
    private Expr Expr;

    public DesignatorIdentExprListExpr (DesignatorIdentExprList DesignatorIdentExprList, Expr Expr) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesignatorIdentExprListExpr(\n");
